...
final class PolicyClassBuilder implements AbstractBuilder
{
    ...
    public function __construct(
        ...
        $this->setName($name ? (!Str::endsWith($name, 'Policy') ? Str::camelize($name).'Policy' : Str::camelize($name)) : static::__NAME__);
